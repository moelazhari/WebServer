...
/*   Updated: 2023/03/17 20:30:14 by mazhari          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "response.hpp"

void    response::cgi(server serv, request req, std::string fileName){
...
char	*respons::getCGIPaths(std::string fileName){
...
void	respons::setEnv(server& server, ParseRequest& request){
